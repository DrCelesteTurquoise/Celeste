...
def start_entity_GPC(Entity_name, sub_addr, sub_port, pub_addr, pub_port):
...
if __name__ == "__main__":
    ...
    sub_port = "56666"
    pub_addr = "192.168.12.200"
    pub_port = "56656"
    start_entity_GPC(Entity_name, sub_addr, sub_port, pub_addr, pub_port)
