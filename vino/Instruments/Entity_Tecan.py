...
def start_entity_Tecan(Entity_name, sub_addr, sub_port, pub_addr, pub_port):
...
if __name__ == "__main__":
    ...
    sub_port = "56666"
    pub_addr = "192.168.12.220"
    pub_port = "56676"
    start_entity_Tecan(Entity_name, sub_addr, sub_port, pub_addr, pub_port)
