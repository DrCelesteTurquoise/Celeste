...
def configuration():
    ...
    window_configuration = sg.Window('MiR250 Configuration Launcher', layout_configuration, icon=r'C:\NFTT\BTC\Test\VINODDD\MiR250\MirEncapsulation\IMG\mir250.ico')
